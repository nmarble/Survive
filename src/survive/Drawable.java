...
public abstract class Drawable {
  ...
  public void fadeRotDraw(final Graphics2D g, final Coords offset, int degree, float alpha) {
    sprite.fadeRotDraw(g, coords.getX() - offset.getX(), coords.getY() - offset.getY(), degree, alpha);
  }
